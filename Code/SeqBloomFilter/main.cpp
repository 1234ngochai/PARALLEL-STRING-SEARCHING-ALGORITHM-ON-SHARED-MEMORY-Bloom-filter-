...
#include <vector>
#include <string>
#include "function/UniqueWordsSeq.h"
...
int main() {
    ...
    /// MOBY_DICK   SHAKESPEARE   LITTLE_WOMEN
    ...
    std::string line;
    int lineCount = 0; // Initialize a counter variable
    ...
    // querying the list of query words
    ...
    std::cout << "Time to query all the input. Process time(s): " << time_taken2 << "number of word" << lineCount << '\n';
